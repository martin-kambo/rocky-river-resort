...
EOF
echo "✓ 95 notifications.service.spec.ts"
cat /mnt/user-data/outputs/rocky-river-resort-v2/apps/api/src/modules/notifications/notifications.service.spec.ts
Output

✓ 95 notifications.service.spec.ts
import { Test, TestingModule }  from '@nestjs/testing'
import { NotificationsService } from './notifications.service'
import { ConfigService }        from '@nestjs/config'
import { EMAIL_PROVIDER }       from '../../infrastructure/email/email-provider.interface'
