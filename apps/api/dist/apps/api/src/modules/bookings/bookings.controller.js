...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all bookings for the current user' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get a booking by reference number' }),
    openapi.ApiResponse({ status: 200, type: Object }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Cancel a booking (48h policy applied)' }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
